...
- interactive Chromium suite: **8 / 8** serial journeys, including profile create/edit/readiness/default/archive/restore; complete exact request read/withdraw/copy/republish/status journeys on desktop and at 390 × 844; payment guidance; exact-user isolation; and Admin evidence;
...
- **8 / 8** complete interactive Chromium journeys, including the full request lifecycle on desktop and mobile;
