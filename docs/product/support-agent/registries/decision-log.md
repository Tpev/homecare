...
- Status: Accepted; implemented in source; production deployment and publication deferred
...
- Release boundary: No production deployment or KB publication occurs while active shifts are underway. Batch 3 and Batch 4 will receive one joint review and deployment. The exact two-user pilot remains the only audience and **Live for everyone** remains off.
