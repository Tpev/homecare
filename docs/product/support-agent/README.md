...
For current operations, read item 38 before the historical limited-release records in items 28–37. `DEC-072` supersedes their approval, evidence, exact-commit, and expansion gates while retaining the implemented safety behavior. Use item 39 as the portfolio tracker for Family-user information and action coverage, item 40 as the implementation contract for reading live state, navigating, highlighting, prefilling, and verifying completion, item 41 for the Family Batch 1–5 executable catalog and mass harness, item 42 for the Batch 1–2 production pilot findings, item 43 for the mobile chat interaction contract, item 44 for the task-first navigation correction, item 45 as the master delivery plan, item 46 for Family Operations KB Wave 1, item 47 for the Batch 3 operating layer, item 48 for the deployed Batch 4 payment/time implementation, item 49 for the authenticated Batch 4.1 corrections, and item 50 for the latest Batch 5 care-profile and request-lifecycle implementation and deployment procedure.
