...
- Confirm reserved-matter term limits such as contract duration; current dollar thresholds are set at $10,000.
...
Summary of authorized, issued, outstanding, and unissued shares. It is a corporate record, not usually signed as an agreement.

`initial-cap-table-and-stock-ledger.xlsx`

Spreadsheet version of the cap table and stock ledger. Useful as the working equity record.
...
Notice confirming Charles's shares are issued in uncertificated form and recorded in the stock ledger.

`06-uncertificated-share-notice-thibaud-peverelli.docx`

Notice confirming Thibaud's shares are issued in uncertificated form and recorded in the stock ledger.

`07-stock-ledger.docx`

Official company record of stock issuances and stockholders of record.

`08-founder-payment-receipts.docx`

Company receipts acknowledging that each founder paid for their shares.

`09-closing-checklist.docx`

Operational checklist for completing and archiving the founder stock issuance.
...
Corporate bylaws governing stockholder meetings, board meetings, director voting, officers, shares, records, indemnification, contracts, and amendments.
...
Stockholder consent confirming Charles and Thibaud as directors and approving the governance agreement.

`05-board-consent-adopting-governance.docx`

Board consent adopting the bylaws, governance agreement, reserved matters, authority matrix, conflict policy, indemnification agreements, and officer appointments.
...
List of major decisions requiring approval of both directors and both founders.

`08-indemnification-agreement-charles-petrini-poli.docx`

Indemnification agreement protecting Charles in his director/officer capacity to the extent permitted by Delaware law.

`09-indemnification-agreement-thibaud-peverelli.docx`

Indemnification agreement protecting Thibaud in his director/officer capacity to the extent permitted by Delaware law.

`10-board-approval-authority-matrix.docx`

Internal delegation matrix showing what officers may approve and what requires board approval.

`11-conflict-of-interest-policy.docx`
...
These documents are built around Delaware corporate-law concepts. Key provisions include DGCL Section 141 for board management, quorum, director voting, written consents, weighted director voting if in the charter, and director removal; DGCL Section 152 for board-authorized stock issuance and consideration; DGCL Section 158 for certificated and uncertificated shares; and DGCL Section 220 for inspection rights.

Sources:

- Delaware DGCL Section 141: https://delcode.delaware.gov/title8/c001/sc04/
