...
return [
    ...
    */
    ...
    'navigation_targets' => [
        ...
        // Compatibility alias for already-published guidance. Family no longer has a
        // separate dashboard; the current signed-in home is the Care overview.
        'family.dashboard' => ['route' => 'family.requests.index', 'roles' => ['family']],
        'family.care_requests' => [
            'route' => 'family.requests.index',
            'roles' => ['family'],
            'client_target_id' => 'family.care_requests',
            'label' => 'Care overview',
            'instruction' => 'Use the highlighted Care overview to see what needs attention and follow each care journey.',
        ],
        'family.care_actions' => [
            'route' => 'family.care.actions',
            'roles' => ['family'],
            'client_target_id' => 'family.care_actions',
            'label' => 'Care actions',
            'instruction' => 'Review the highlighted decisions and problems that need your attention.',
        ],
        'family.care_schedule' => [
            'route' => 'family.care.schedule',
            'roles' => ['family'],
            'client_target_id' => 'family.care_schedule',
            'label' => 'Care schedule',
            'instruction' => 'Use the highlighted schedule to review upcoming visits.',
        ],
        'family.care_arrangements' => [
            'route' => 'family.care.index',
            'roles' => ['family'],
            'client_target_id' => 'family.care_arrangements',
            'label' => 'Care arrangements',
            'instruction' => 'Use the highlighted Arrangements area to review recurring care and care still being arranged.',
        ],
        'family.request.journey' => [
            'route' => 'family.care.journey',
            'roles' => ['family'],
            'resource_type' => 'care_request',
            'route_parameter' => 'resourceId',
            'route_parameters' => ['resourceType' => 'request'],
            'client_target_id' => 'family.request.journey',
            'label' => 'Care journey',
            'instruction' => 'Review the highlighted care journey and its current next step.',
        ],
        'family.recurring_care.journey' => [
            ...
            'route_parameter' => 'resourceId',
            'route_parameters' => ['resourceType' => 'regular'],
            'client_target_id' => 'family.recurring_care.journey',
            'label' => 'Recurring-care journey',
            'instruction' => 'Review the highlighted recurring-care journey and its current next step.',
        ],
        'family.caregivers' => [
            'route' => 'caregivers.search',
            'roles' => ['family'],
            'client_target_id' => 'family.caregivers',
            'label' => 'Find caregivers',
            'instruction' => 'Use the highlighted caregiver search and filters to browse available profiles.',
        ],
        'family.caregiver_profile' => [
            'route' => 'caregivers.show',
            'roles' => ['family'],
            'resource_type' => 'caregiver_profile',
            'resource_route_key' => 'slug',
            'route_parameter' => 'slug',
            'client_target_id' => 'family.caregiver_profile',
            'label' => 'Caregiver profile',
            'instruction' => 'Review the highlighted caregiver profile and its current public information.',
        ],
        ...
        'family.regular_care.attention' => [
            ...
            'instruction' => 'Review the highlighted recurring-care item that needs attention.',
        ],
        'family.regular_care' => [
            'route' => 'family.care.index',
            'roles' => ['family'],
        ...
        'family.billing.payment_method' => [
            ...
            'fallback_target' => 'family.care_requests',
        ],
