...
func Load() (Config, error) {
	cfg := Config{
		...
		DeepgramProviderGreeting:   env("DEEPGRAM_PROVIDER_OUTREACH_GREETING", "Hi, this is Julie with LoLo Care. Who handles local resource options for families asking about non-medical help at home, like companionship, errands, meal prep, or respite?"),
