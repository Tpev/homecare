...
<head>
    ...
    <title>Family access ended | LoLo Care</title>
...
<body class="min-h-screen bg-[#FFF9EF] text-[#17313F] antialiased">
    <main class="flex min-h-screen items-center justify-center p-5">
        <section class="w-full max-w-lg rounded-3xl border border-[#E3D6C5] bg-white p-7 text-center shadow-xl sm:p-10" aria-labelledby="access-heading">
            ...
            <h1 id="access-heading" class="mt-2 font-display text-3xl font-semibold leading-tight" tabindex="-1">Your access to this family account has ended.</h1>
            <p class="mt-4 text-sm leading-6 text-[#5D6D67]">You can no longer see this family’s care, visits, messages, or billing history. The account owner can invite you again if access is needed.</p>
