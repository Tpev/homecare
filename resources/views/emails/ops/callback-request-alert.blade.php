...
<head>
    <meta charset="utf-8">
    <title>LoLo callback request</title>
</head>
<body style="font-family: Arial, sans-serif; color: #24302d; background: #fff7ea; margin: 0; padding: 24px;">
    <div style="max-width: 680px; margin: 0 auto; background: #fffaf0; border: 1px solid #eadfce; border-radius: 18px; padding: 24px;">
        ...
        <h1 style="margin: 0 0 12px; color: #23483f; font-size: 28px; line-height: 1.15;">A family asked LoLo to call them back.</h1>
        <p style="margin: 0 0 20px; color: #53645d;">This came from the request-a-callback page. Call the family using the phone number below.</p>
