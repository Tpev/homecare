<div class="hc-page space-y-5 py-5 sm:space-y-6 sm:py-8">
    ...
    <section class="hc-brand-panel">
        <div class="relative flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
                <p class="hc-brand-kicker text-[#E8E0FF]">Recurring care</p>
            ...
            <x-card>
                ...
                <div class="space-y-3 text-sm">
                    ...
                    <div>
                        ...
                        <p class="text-[#607080]">${{ number_format((float) $platformRate, 2) }}/hr care* + ${{ number_format((float) $processingFeeRate, 2) }}/hr processing fee</p>
                    </div>
                    <div>
