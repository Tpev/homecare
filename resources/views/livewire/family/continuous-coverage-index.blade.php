    ...
    <section class="grid gap-5 lg:grid-cols-2">
        ...
        @empty
            <div class="rounded-3xl border border-dashed border-[#CFC4B5] bg-white p-8 text-center lg:col-span-2">
                ...
                <h2 class="mt-4 font-display text-2xl font-semibold text-[#17313F]">No Continuous Coverage plan yet</h2>
                ...
                <a href="{{ route('family.continuous-coverage.create') }}" wire:navigate class="mt-5 inline-flex min-h-12 items-center justify-center rounded-xl bg-[#0F3D3E] px-5 py-3 font-semibold text-white">Create your first plan</a>
            </div>
        @endforelse
    </section>
</div>
