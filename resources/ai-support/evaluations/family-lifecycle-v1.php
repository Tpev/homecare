...
return [
    ...
    'cases' => [
        ...
        $case('FAM-PROFILE-019', ['Make Maria the default care profile.', 'Change the default care receiver profile.', 'Use this profile by default.'], 'Batch5FamilyLifecycleTest::test_default_archive_and_restore_are_each_confirmed_and_database_verified'),
        $case('FAM-PROFILE-020', ['Archive Maria’s profile.', 'Please archive this care receiver profile.', 'Hide this profile from new requests.', 'Archive the Batch Five Test Profile now that the pilot test is complete.'], 'Batch5FamilyLifecycleTest::test_default_archive_and_restore_are_each_confirmed_and_database_verified'),
        $case('FAM-PROFILE-021', ['Restore Maria’s archived profile.', 'Bring back the archived care profile.', 'Restore this care receiver profile.'], 'Batch5FamilyLifecycleTest::test_default_archive_and_restore_are_each_confirmed_and_database_verified'),
        $case('FAM-REQUEST-020', ['Reuse my last care request.', 'Start with the same request as last time.', 'Reuse the previous request details.'], 'Batch5FamilyLifecycleTest::test_reuse_duplicate_live_replacement_type_replacement_and_withdrawn_copy_are_distinct'),
        $case('FAM-REQUEST-034', ['What is the status of my care request?', 'Where does request #12 stand?', 'Check my current request status.'], 'Batch5FamilyLifecycleTest::test_exact_request_status_blockers_and_applicant_count_are_read_from_authorized_state'),
        $case('FAM-REQUEST-035', ['Did any caregivers apply to my request?', 'How many caregiver responses are on my request?', 'Show the applicants for my care request.'], 'Batch5FamilyLifecycleTest::test_exact_request_status_blockers_and_applicant_count_are_read_from_authorized_state'),
        $case('FAM-REQUEST-036', ['Edit my live care request.', 'Change the date on the open request.', 'Update the tasks on my published request.'], 'Batch5FamilyLifecycleTest::test_reuse_duplicate_live_replacement_type_replacement_and_withdrawn_copy_are_distinct'),
        $case('FAM-REQUEST-037', ['Change my live one-time request to regular care.', 'Turn this regular request into one-time care.', 'Change the type of my published request.'], 'Batch5FamilyLifecycleTest::test_reuse_duplicate_live_replacement_type_replacement_and_withdrawn_copy_are_distinct'),
        ...
        $case('FAM-REQUEST-039', ['Make a fresh copy of my expired request.', 'Restore my withdrawn request as a new one.', 'Reopen the cancelled request by copying it.'], 'Batch5FamilyLifecycleTest::test_reuse_duplicate_live_replacement_type_replacement_and_withdrawn_copy_are_distinct'),
        $case('FAM-REQUEST-040', ['Duplicate my care request.', 'Copy request #12 into a new draft.', 'Make another request from this one.'], 'Batch5FamilyLifecycleTest::test_reuse_duplicate_live_replacement_type_replacement_and_withdrawn_copy_are_distinct'),
    ],
];
