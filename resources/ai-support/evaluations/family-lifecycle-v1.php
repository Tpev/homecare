...
return [
    ...
    'cases' => [
        ...
        $case('FAM-PROFILE-020', ['Archive Maria’s profile.', 'Please archive this care receiver profile.', 'Hide this profile from new requests.', 'Archive the Batch Five Test Profile now that the pilot test is complete.'], 'Batch5FamilyLifecycleTest::test_stale_profile_confirmation_is_denied_and_does_not_archive'),
