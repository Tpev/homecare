...
class InteractiveSupportRuntimeTest extends TestCase
{
    ...
    public function test_continuous_coverage_transfers_without_model_or_queue_claims(): void
    {
        ...
        $this->assertSame("I've transferred your 24/7 continuous-care request to LoLo Support. They'll reply here.", $message->body);
        $this->assertSame('Chat: Help with 24/7 continuous care', $ticket->subject);
