...
type AccountKey = 'family' | 'familyMember' | 'familyAi' | 'familyAiMember' | 'familyJourney' | 'familyEligible' | 'familyRemoved' | 'caregiverReady' | 'caregiverMobileVisual' | 'caregiverNew' | 'caregiverMarketplace' | 'admin';
