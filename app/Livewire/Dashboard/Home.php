    ...
    private function notificationEventMapForRole(string $role): array
    {
        if ($role === 'family') {
            return [
                ...
                MarketplaceEvent::REGULAR_CARE_ACCEPTED => ['label' => 'Recurring care', 'tone' => 'success'],
                MarketplaceEvent::REGULAR_CARE_COUNTERED => ['label' => 'Recurring care', 'tone' => 'warning'],
                MarketplaceEvent::REGULAR_CARE_DECLINED => ['label' => 'Recurring care', 'tone' => 'warning'],
                ...
                MarketplaceEvent::REGULAR_CARE_PAUSED => ['label' => 'Recurring care paused', 'tone' => 'warning'],
                MarketplaceEvent::REGULAR_CARE_RESUMED => ['label' => 'Recurring care resumed', 'tone' => 'success'],
                MarketplaceEvent::REGULAR_CARE_ENDED => ['label' => 'Recurring care ended', 'tone' => 'warning'],
        ...
        return [
            ...
            MarketplaceEvent::REGULAR_CARE_OFFERED => ['label' => 'Recurring care', 'tone' => 'info'],
            MarketplaceEvent::REGULAR_CARE_ACCEPTED => ['label' => 'Recurring care', 'tone' => 'success'],
            MarketplaceEvent::REGULAR_CARE_ENDED => ['label' => 'Recurring care', 'tone' => 'warning'],
