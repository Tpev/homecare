...
class AiSupportOpenAiClient
{
    ...
    public function schema(): array
    {
        ...
        return [
            ...
            'required' => ['operation', 'message', 'navigation_target_id', 'care_path', 'clarifying_question', 'confidence_band', 'kb_stable_ids', 'draft_patch', 'profile_patch'],
            'properties' => [
                'operation' => ['type' => 'string', 'enum' => ['answer', 'navigate', 'handoff', 'care_path', 'draft_patch', 'profile_patch']],
                'message' => ['type' => 'string'],
                ...
                'profile_patch' => [
                    ...
                    'additionalProperties' => false,
                    'required' => [
                        'patch_fields', 'recipient_is_requester', 'full_name', 'preferred_name',
                        'date_of_birth', 'age_range', 'pronouns', 'relationship_to_family',
                        'about_them', 'interests_and_comforts', 'good_visit_notes',
                        'communication_preferences', 'communication_notes', 'everyday_health_context',
                        'support_areas', 'support_details', 'mobility_level', 'mobility_notes',
                        'routine_notes', 'food_and_drink_notes', 'personal_care_preferences',
                        'sleep_overnight_notes', 'comfort_needs', 'distress_triggers',
                        'calming_approaches', 'safety_items', 'safety_notes',
                        'caregiver_quality_preferences', 'caregiver_do_notes', 'caregiver_avoid_notes',
                        'include_additional_contact', 'additional_contact_name',
                        'additional_contact_relationship', 'additional_contact_phone',
                        'additional_contact_email', 'assigned_escalation_notes',
                    ],
                    'properties' => [
                        'patch_fields' => ['type' => 'array', 'items' => ['type' => 'string']],
                        'recipient_is_requester' => $nullableBoolean,
                        ...
                        'age_range' => $nullableString,
                        'pronouns' => $nullableString,
                        'relationship_to_family' => $nullableString,
                        'about_them' => $nullableString,
                        'interests_and_comforts' => $nullableString,
                        'good_visit_notes' => $nullableString,
                        'communication_preferences' => ['type' => 'array', 'items' => ['type' => 'string']],
                        'communication_notes' => $nullableString,
                        'everyday_health_context' => $nullableString,
                        ...
                        'mobility_level' => $nullableString,
                        'mobility_notes' => $nullableString,
                        'routine_notes' => $nullableString,
                        'food_and_drink_notes' => $nullableString,
                        'personal_care_preferences' => $nullableString,
                        'sleep_overnight_notes' => $nullableString,
                        'comfort_needs' => ['type' => 'array', 'items' => ['type' => 'string']],
                        'distress_triggers' => $nullableString,
                        'calming_approaches' => $nullableString,
                        'safety_items' => ['type' => 'array', 'items' => ['type' => 'string']],
                        'safety_notes' => $nullableString,
                        'caregiver_quality_preferences' => ['type' => 'array', 'items' => ['type' => 'string']],
                        'caregiver_do_notes' => $nullableString,
                        'caregiver_avoid_notes' => $nullableString,
                        'include_additional_contact' => $nullableBoolean,
                        'additional_contact_name' => $nullableString,
                        'additional_contact_relationship' => $nullableString,
                        'additional_contact_phone' => $nullableString,
                        'additional_contact_email' => $nullableString,
                        'assigned_escalation_notes' => $nullableString,
                    ],
                ],
            ],
        ];
